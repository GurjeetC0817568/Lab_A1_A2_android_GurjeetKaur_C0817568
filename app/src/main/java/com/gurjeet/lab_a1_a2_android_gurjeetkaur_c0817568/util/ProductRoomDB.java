            ...
            new RoomDatabase.Callback() {
                ...
                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                    ...
                    databaseWriteExecutor.execute(() -> {
                        ...
                        Product pd = new Product(1,"iPhone5","Demo details text about iPhone5. Wide camera, retina display, water resistant, privacy built in.","100","10-10-2021");
                        Product pd2 = new Product(1,"iPhoneX","Demo details text about iPhoneX, advanced dual-camera system.","200","11-10-2021");
                        Product pd3 = new Product(1,"iPad Mini","Demo details text about iPad Mini","300","12-10-2021");
                        Product pd4 = new Product(1,"Macbook Pro","Demo details text about macbookpro","1000","13-10-2021");
                        Product pd5 = new Product(1,"Apple AirPod","Demo details text about airpod","150","14-10-2021");
                        pDao.insertProduct(pd);pDao.insertProduct(pd2);pDao.insertProduct(pd3);pDao.insertProduct(pd4);pDao.insertProduct(pd5);
                        Product pd6 = new Product(2,"Samsung Galaxy","Demo details text about Samsung Galaxy, advanced dual-camera system","100","10-10-2021");
                        Product pd7 = new Product(2,"Samsung S1","Demo details text about Samsung S1 mobile with retina display, water resistant","200","11-10-2021");
                        Product pd8 = new Product(2,"Smart 4K TV","Demo details text about Samsung TV","300","12-10-2021");
                        Product pd9 = new Product(2,"Galaxy Z Flip","Demo details text about Galaxy Z Flip mobile","400","13-10-2021");
                        Product pd10 = new Product(2,"Galaxy Watch 4","Demo details text about Galaxy Watch 4","50","14-10-2021");
